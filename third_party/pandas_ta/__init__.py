# -*- coding: utf-8 -*-
# Vendored: Guard package metadata lookup so it works without installation
try:
    from importlib.metadata import version as _pkg_version
    __version__ = _pkg_version("pandas-ta")
except Exception:
    # Fallback version for vendored distribution (adjust if needed)
